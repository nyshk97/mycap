...
/// mycap が使うホットキー（固定）。常用版は CleanShot X で使っていた ⌘⇧ 系を引き継ぐ。
...
enum HotKeyBindings {
    ...
    static let ocr = Binding(keyCode: kVK_ANSI_2, modifiers: mods, label: prefix + "2")
    static let fullScreen = Binding(keyCode: kVK_ANSI_3, modifiers: mods, label: prefix + "3")
